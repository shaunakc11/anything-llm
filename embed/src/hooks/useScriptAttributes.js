...
const DEFAULT_SETTINGS = {
  ...
  sponsorText: "Powered by OssorioiaLLM", // default sponsor text
  sponsorLink: "https://ossorioia.com", // default sponsor link
  position: "bottom-right", // position of chat button/window
  assistantName: "OssorioiaLLM Chat Assistant", // default assistant name
  ...
  useEffect(() => {
    function fetchAttribs() {
      ...
      if (
        ...
        throw new Error(
          "[OssorioiaLLM Embed Module::Abort] - Invalid script tag setup detected. Missing required parameters for boot!"
        );
