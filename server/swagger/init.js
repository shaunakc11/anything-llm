...
const doc = {
  info: {
    version: "1.0.0",
    title: "OssorioIALLM Developer API",
    description:
      "API endpoints that enable programmatic reading, writing, and updating of your OssorioIALLM instance. UI supplied by Swagger.io.",
  },
