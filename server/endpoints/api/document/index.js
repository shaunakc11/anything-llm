...
function apiDocumentEndpoints(app) {
  ...
  app.post(
    ...
    #swagger.description = 'Upload a new file to OssorioIALLM to be parsed and prepared for embedding.'
    #swagger.requestBody = {
      ...
      content: {
        "application/json": {
          schema: {
            type: 'object',
            example: {
              "textContent": "This is the raw text that will be saved as a document in OssorioIALLM.",
              "metadata": {
                keyOne: "valueOne",
                keyTwo: "valueTwo",
                etc: "etc"
  ...
  app.get("/v1/document/:docName", [validApiKey], async (request, response) => {
    /*
    #swagger.tags = ['Documents']
    #swagger.description = 'Get a single document by its unique OssorioIALLM document name'
